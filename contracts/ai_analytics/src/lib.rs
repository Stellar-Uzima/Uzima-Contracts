...
impl AiAnalyticsContract {
    ...
    pub fn start_round(
        ...
        env.events().publish((symbol_short!("RoundStarted"),), id);
        id
    }
    ...
    pub fn submit_update(
        ...
        env.events()
            .publish((symbol_short!("UpdateSubmitted"),), (round_id, participant));
    ...
    pub fn finalize_round(
        ...
        env.events()
            .publish((symbol_short!("RoundFinalized"),), (round_id, new_model_id));
