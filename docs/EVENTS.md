...
- Generated at: `2026-09-01T18:15:50.692Z`

## access_control

| Topics | Payload | Source |
|---|---:|---|
| `AC` · `ADMIN` | single (1) | `contracts/access_control/src/lib.rs:147` |
| `AC` · `BATCH_G` | single (1) | `contracts/access_control/src/lib.rs:278` |
| `AC` · `BATCH_G` | tuple (2) | `contracts/access_control/src/lib.rs:375` |
| `AC` · `BATCH_PRM` | tuple (2) | `contracts/access_control/src/lib.rs:326` |
| `AC` · `BATCH_R` | tuple (2) | `contracts/access_control/src/lib.rs:399` |
| `AC` · `BATCH_REV` | tuple (2) | `contracts/access_control/src/lib.rs:350` |
| `AC` · `GRANT_P` | tuple (2) | `contracts/access_control/src/lib.rs:218` |
| `AC` · `INIT` | single (1) | `contracts/access_control/src/lib.rs:118` |
| `AC` · `REVOKE` | single (1) | `contracts/access_control/src/lib.rs:174` |
| `AC` · `REVOKE` | single (1) | `contracts/access_control/src/lib.rs:298` |
| `AC` · `REVOKE_P` | tuple (2) | `contracts/access_control/src/lib.rs:235` |
| `AC` | tuple (2) | `contracts/access_control/src/lib.rs:253` |

## ai_analytics

| Topics | Payload | Source |
|---|---:|---|
| `AI_AN` · `INIT` | single (1) | `contracts/ai_analytics/src/admin.rs:11` |
...
| Topics | Payload | Source |
|---|---:|---|
| `AML` · `CFG_RULE` | tuple (2) | `contracts/aml/src/lib.rs:86` |
| `AML` · `STATUS` | tuple (2) | `contracts/aml/src/lib.rs:266` |
| `AML` · `VIOLATION` | tuple (2) | `contracts/aml/src/lib.rs:323` |
...
| Topics | Payload | Source |
|---|---:|---|
| `pause` | tuple (2) | `contracts/common_error/src/pause.rs:22` |
| `unpause` | tuple (2) | `contracts/common_error/src/pause.rs:24` |
...
| Topics | Payload | Source |
|---|---:|---|
| `GENOMIC_CONSENT` · `WITHDRAWAL` | single (1) | `contracts/genomic_data/src/lib.rs:693` |
