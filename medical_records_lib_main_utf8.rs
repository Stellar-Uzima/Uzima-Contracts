...
/// Per-field quality score for a medical record (each field scored 0ΓÇô10_000 BPS).
#[derive(Clone)]
#[contracttype]
pub struct DataQualityScore {
    /// Overall quality score (0ΓÇô10_000 basis points, i.e. 10_000 = 100%).
...
impl MedicalRecordsContract {
    ...
    /// Internal guard ΓÇô called at the start of rate-limited operations.
